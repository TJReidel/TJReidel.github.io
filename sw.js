const CACHE="pillplan-v15-releasegate1";
const SHELL=["/index.html","/manifest.json","/adherence-v2.js","/adherence-v2-adapter.js","/pillplan-v12-correction-ui.js","/pillplan-local-date-v1.js","/pillplan-v12-schedule-change-ui.js","/pillplan-v12-medication-end-ui.js","/medication-schedule-v1.js","/statistics-v2.js","/pillplan-release-gate-v1.js","/icon.png","/icon-512.png"];
...
async function injectUiScripts(response){
  try{
    ...
    if(!text.includes("pillplan-release-gate-v1.js")) text=text.replace("</body>",'<script src="/pillplan-release-gate-v1.js"></script></body>');
